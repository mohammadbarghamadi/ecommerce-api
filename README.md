...
## نحوه ارسال ریکوست
برای ارسال ریکوست به بک اند به فرمت JSON باید طبق دستورالعمل های زیر اقدام کنید، توجه کنید بجای مقدار http://localhost:8000 باید از آدرس سرور مورد نظر خود استفاده کنید.
...
http://localhost:3000/reset/4447f4ea8917250b4bdf3f3d1946f42f977
